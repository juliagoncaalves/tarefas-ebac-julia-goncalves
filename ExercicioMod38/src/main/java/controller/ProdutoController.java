...
import com.marcelocbasilio.service.IProdutoService;
...
public class ProdutoController implements Serializable {
    ...
    public void init() {
        try {
            ...
            FacesContext.getCurrentInstance().addMessage("growl",
                    new FacesMessage("Erro ao tentar listar os produtos"));
        }
    }
    ...
    public void update() {
        try {
            ...
            FacesContext.getCurrentInstance().addMessage("growl",
                    new FacesMessage("Erro ao tentar atualizar o produto"));
        }
