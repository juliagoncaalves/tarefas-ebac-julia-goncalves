...
public class VendaController implements Serializable {
    ...
    public void adicionarProduto() {
        Optional<ProdutoQuantidade> prodOp = this.venda.getProdutos().stream()
                .filter(prodF -> prodF.getProduto().getCodigo().equals(this.produtoSelecionado.getCodigo()))
                .findFirst();
    ...
    public void onRowEdit(RowEditEvent event) { // RowEditEvent<ProdutoQuantidade> event
...
//		FacesMessage msg = new FacesMessage("Edit Cancelled", String.valueOf(event.getObject().getId()));
        FacesMessage msg = new FacesMessage("Edit Cancelled", "ID: " + ((ProdutoQuantidade) event.getObject()).getId());
